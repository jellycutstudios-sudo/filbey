      ...
      <div className="flex flex-col md:flex-row justify-between gap-gutter px-margin-mobile md:px-margin-desktop py-stack-lg max-w-container-max mx-auto">
        ...
        <div className="flex flex-col gap-stack-sm">
          ...
          <Link
            ...
            className="flex items-start gap-2 mt-4 text-surface-variant/70 font-body-md text-body-md hover:text-secondary-container transition-colors"
          >
        ...
        <div className="flex flex-col gap-stack-sm mt-stack-md md:mt-0 md:text-right">
          ...
          <div className="flex gap-4 mt-4 md:justify-end">
            ...
            <Link
              ...
              className="w-10 h-10 rounded-full bg-surface-variant/20 flex items-center justify-center text-surface-bright hover:bg-[#25D366] transition-colors"
            >
            ...
            <Link
              ...
              className="w-10 h-10 rounded-full bg-surface-variant/20 flex items-center justify-center text-surface-bright hover:bg-[#E1306C] transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
